                ...
                <div class="col-xl-5 col-lg-5">
                    <div class="about_info">
                          <h3>Quem Somos</h3><br/>
                            ...
                            <h3>A Pousada Parnaioca <br>
                                    </h3>
                        </div>
                        <p>Fomos Fundado em 2015, pelos amigos e desenvolvedores Juan felipe e David de carvalho, eles tinham como objetivo criar um site de sua pousada e facilitar o acesso de reservas para as pessoas que tinham mais dificuldades em fazer reservas online.</p>
                        <a href="#" class="line-button">Saiba mais</a>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xl-6 col-md-6">
                    <div class="single_about_info">
                        <h3>Servimos comidas frescas <br>
                           e deliciosas</h3>
                            <p>Servimos comidas que pescamos na hora e assando para os demais situados na pousada, lembrando um pouco o tema de acampamento.
                            </p>
                    </div>
                </div>
                <div class="col-xl-6 col-md-6">
                    ...
                    <div class="Query_border">
                        <div class="row align-items-center justify-content-center">
                            <div class="col-xl-6 col-md-6">
                                ...
                                Quer reservar uma suíte? Conta-te nos!</p>
                                </div>
                            </div>
                            <div class="col-xl-6 col-md-6">
                                <div class="phone_num">
                                    <a href="#" class="mobile_no">(021)97338-9448</a>
                                </div>
                            </div>
                        </div>
                    </div>
